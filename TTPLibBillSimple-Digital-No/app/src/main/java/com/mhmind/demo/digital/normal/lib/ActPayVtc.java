...
import com.mhmind.ttp.view.TTPActPayVtc;

import android.os.Bundle;
import android.widget.TextView;

public class ActPayVtc extends TTPActPayVtc {

	@Override
	public void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.ttp_act_pay_vtc);
        ...
        tvTitleCenter.setText(R.string.ttp_title_pay_vtc);
