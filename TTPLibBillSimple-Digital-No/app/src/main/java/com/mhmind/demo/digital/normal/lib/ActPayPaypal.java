...
import com.mhmind.ttp.view.TTPActPayPaypal;

public class ActPayPaypal extends TTPActPayPaypal {

	@Override
	public void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.ttp_act_pay_paypal);
        ...
        tvTitleCenter.setText(R.string.ttp_title_pay_paypal);
