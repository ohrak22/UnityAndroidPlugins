...
import com.mhmind.ttp.view.TTPActPayUniPin;

public class ActPayUniPin extends TTPActPayUniPin {

	@Override
	public void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.ttp_act_pay_unipin);
        ...
        tvTitleCenter.setText(R.string.ttp_title_pay_unipin);
