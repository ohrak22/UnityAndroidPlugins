...
import com.mhmind.ttp.view.TTPActPayCulture;

public class ActPayCulture extends TTPActPayCulture {

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.ttp_act_pay_culture);
        ...
        tvTitleCenter.setText(R.string.ttp_title_pay_culture);
