...
import com.mhmind.ttp.view.TTPActPayMolCoupon;

public class ActPayMolCoupon extends TTPActPayMolCoupon{

	@Override
	public void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.ttp_act_pay_mol_coupon);
        ...
        tvTitleCenter.setText(R.string.ttp_title_pay_mol);
